...
local item1 = AlignNode{inUI = true, isRoot = true} -- 6
local box = Node() -- 7
box.size = Size(700,50) -- 7
item1:addChild(box) -- 7
item1.box = box -- 7
local item2 = SolidRect{width = 900, x = -100, y = -75, height = 200, color = 0x88000000} -- 8
...
local item3 = SolidRect{width = 650, height = 50} -- 12
